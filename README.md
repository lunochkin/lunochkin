...
- **[research-agent](https://github.com/lunochkin/research-agent)** — Multi-agent RAG over an arXiv corpus: plan → parallel-retrieve → synthesize → verify, hybrid pgvector + Postgres FTS retrieval, bounded re-retrieval. Hand-rolled Go orchestrator, no LangChain/CrewAI. In active development.
- **[anki-llm-assistant](https://github.com/lunochkin/anki-llm-assistant)** — Spec-first development case study: specs → generated tools → invariant validation, demonstrated on a conversational Anki assistant. Companion to my spec-first article. Python.
- **[github-intel](https://github.com/lunochkin/github-intel)** — GH Archive ingestion with resumable backfill into ClickHouse; minimal summary API and dashboard. Early stage. Go.
...
- Website — [lunochkin.com](https://lunochkin.com)
- LinkedIn — [maksim-lunochkin](https://www.linkedin.com/in/maksim-lunochkin)
- Email — maksim@lunochkin.com
